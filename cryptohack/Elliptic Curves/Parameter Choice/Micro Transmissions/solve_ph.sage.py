...
for A_try in [A, -A]:
    ...
    for n_cand in [n_a, n_a % (_sage_const_2 **_sage_const_64 )]:
        if n_cand * G == A:
            shared = int((n_cand * B).xy()[_sage_const_0 ])
